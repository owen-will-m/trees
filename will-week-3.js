     ...
     function mousePressed() {
          ...
          if (drawingPath) {
               ...
               trees.push(newTree(mouseX, mouseY, DEPTH, mouseY / 4, mouseY / 200.0, TREECOLORS[getRandomInt(TREECOLORS.length)]));
     ...
     function mouseDragged() {
          if (drawingPath) {
               if (prevMouseX != 0) {
                    trees.push([prevMouseY / 10.0, 100, 0, [
                         [prevMouseX, prevMouseY],
                         [mouseX, mouseY]
                    ]]); //0: size 1: color  2: 0 3: contains the line
               }
               prevMouseX = mouseX;
               prevMouseY = mouseY;
          }
     ...
     function setup() {
          ...
          button.mousePressed(clearTrees);
